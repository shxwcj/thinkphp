<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"D:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\system\admin_user.html";i:1489983998;s:86:"D:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\public\head.html";i:1484792114;s:88:"D:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\public\navbar.html";i:1489979851;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="sui-layout">
    ...
    <div class="main-t" id="app" v-cloak>
        ...
        <div class="content">
            ...
            <!--end breadcrumb-->
            <form class="queryForm sui-form form-horizontal" action="<?php echo url('admin_user'); ?>" method="post">
                ...
                <div class=" pull-right"><a href="<?php echo url('admin_user_add'); ?>" class="sui-btn btn-success">添加管理员</a></div>
            </form>
            ...
            <table class="sui-table table-bordered table-hover" id="list-content">
                ...
                <tr>
                    ...
                    <td class="center">
                        <a href="<?php echo url('admin_user_edit'); ?>?id=<?php echo $vo['id']; ?>">修改</a>
                        -
                        <a href="javascript:void(0)" onclick="admin_user_delete(<?php echo $vo['id']; ?>)">删除</a>
                    </td>
                </tr>
            ...
            <div class="span4 pull-left">
                <a href="javascript: void(0);" class="btn-link" onclick="admin_user_setstatus(1)">批量启用</a>-
                <a href="javascript: void(0);" class="btn-link" onclick="admin_user_setstatus(0)">批量禁用</a>
            </div>
            <!-- 分页 -->
...
<script type="text/javascript">
    ...
    function admin_user_setstatus(status) {
        var ids = Array();
        $('input[name="checkbox"]:checked').each(function(){
            ids.push($(this).val());
        });
        var url = "<?php echo url('admin_user_setstatus'); ?>";
        //询问框
        layer.confirm('是否操作？', {
            btn: ['确定','取消'] //按钮
        }, function(){
    ...
    function admin_user_delete(id) {
        var url = "<?php echo url('admin_user_delete'); ?>";
        //询问框
        layer.confirm('是否删除？', {
            btn: ['确定','取消'] //按钮
        }, function(){
