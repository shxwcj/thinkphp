<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"D:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\goods\cate_list.html";i:1484531210;s:86:"D:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\public\head.html";i:1484792114;s:88:"D:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\public\navbar.html";i:1489979851;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="main-t" id="app" v-cloak>
        <div class="sidebar">
            <ul class="sui-nav nav-list nav-large">
                ...
                <li class="active"><a href="<?php echo url('goods/cate_list'); ?>"><i class="sui-icon icon-tb-right pull-right mt3"></i>分类管理</a></li>
        ...
        <div class="content">
            ...
            <!--end breadcrumb-->
            <form class="queryForm sui-form form-inline" action="<?php echo url('cate_list'); ?>" method="post">
