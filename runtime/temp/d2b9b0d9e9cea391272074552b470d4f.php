<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"D:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\cms\cate_list.html";i:1484794137;s:86:"D:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\public\head.html";i:1484792114;s:88:"D:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\public\navbar.html";i:1489979851;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="main-t" id="app" v-cloak>
        <div class="sidebar">
            <ul class="sui-nav nav-list nav-large">
                <li><a href="<?php echo url('cms/index'); ?>">列表</a></li>
                <li class="active"><a href="<?php echo url('cms/cate_list'); ?>">分类<i class="sui-icon icon-tb-right pull-right mt3"></i></a></li>
            </ul>
        </div>
        <div class="content">
            <!--begin breadcrumb-->
            ...
            <!--end breadcrumb-->
            <form class="queryForm sui-form form-inline" action="<?php echo url('cate_list'); ?>" method="get">
                ...
                <div class=" pull-right"><a href="<?php echo url('cate_add'); ?>" class="sui-btn btn-success">添加分类</a></div>
            </form>
            <table class="sui-table table-bordered table-hover" id="list-content">
                ...
                <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td>0</td>
                        <td class="center">
                            <a href="<?php echo url('cate_edit'); ?>?id=<?php echo $vo['id']; ?>">修改</a>
                            -
                            <a href="javascript:void(0)" onclick="cate_delete(<?php echo $vo['id']; ?>)">删除</a>
                        </td>
                    </tr>
            ...
            <!-- 分页 -->
            <div class="c-pagination clearfix"><?php echo $list->render(); ?></div>
        </div>
    </div>
</div>
</body>
...
<script type="text/javascript">
    ...
    function cate_delete(id) {
        var url = "<?php echo url('cate_delete'); ?>";
        //询问框
        layer.confirm('是否删除？', {
            btn: ['确定','取消'] //按钮
        }, function(){
    ...
    function cate_setstatus(status) {
        ...
        console.log(ids);
        var url = "<?php echo url('cate_setstatus'); ?>";
        //询问框
        layer.confirm('是否操作？', {
            btn: ['确定','取消'] //按钮
        }, function(){
