<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\cms\index.html";i:1484793600;s:86:"D:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\public\head.html";i:1484792114;s:88:"D:\phpStudy\PHPTutorial\WWW\thinkphp\public/../application/admin\view\public\navbar.html";i:1489979851;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="sui-layout">
    ...
    <div class="main-t" id="app" v-cloak>
        ...
        <div class="content">
            ...
            <!--end breadcrumb-->
            <form class="queryForm sui-form form-horizontal" action="<?php echo url('index'); ?>" method="get">
                ...
                <div class=" pull-right">
                    <a href="<?php echo url('article_add'); ?>" class="sui-btn btn-success">添加内容</a>
                </div>
            </form>
            ...
            <table class="sui-table table-bordered table-hover" id="list-content">
                ...
                <tr>
                    ...
                    <td class="center">
                        <a href="<?php echo url('article_edit'); ?>?id=<?php echo $vo['id']; ?>">修改</a>
                        -
                        <a href="javascript:void(0)" onclick="article_delete_one(<?php echo $vo['id']; ?>)">删除</a>
                    </td>
                </tr>
...
<script type="text/javascript">
    ...
    function article_delete_one(id) {
        var url = "<?php echo url('article_delete_one'); ?>";
        //询问框
        layer.confirm('是否删除？', {
            btn: ['确定','取消'] //按钮
        }, function(){
    ...
    function cate_setstatus(status) {
        ...
        var url = "<?php echo url('article_delete'); ?>";
        //询问框
        layer.confirm('是否操作？', {
            btn: ['确定','取消'] //按钮
        }, function(){
