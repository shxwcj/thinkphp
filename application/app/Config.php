...
return [
    ...
    'alipay_config'=> array(
        ...
        //参数编码字符集
        'input_charset' => strtolower('utf_8'),
        //服务器异步通知页面路径
        'notify_url' =>'http://shop.test/index.php/app/order/alipay_notify_url',
        //支付类型 默认值为：1（商品购买）
        'payment_type' => 1,
        //卖家支付宝账号
        'seller_id' => '13058185654',
    ...
    'wxpay_config' => array(
        ...
        'notify_url' => 'http://shop.test/index.php/app/order/wxpay_before'
    ),
